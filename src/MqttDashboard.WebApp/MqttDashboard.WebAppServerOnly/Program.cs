...
try
{
    ...
    // Resolve data directory early (same logic as DashboardStorageService)
    ...
    // Load user-specific settings (e.g. admin password hash) from data dir (persists in Docker)
